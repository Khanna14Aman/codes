...
// here c will denote that a how many times a particular element appear in array...
  for(int i=1;i<=maxi;i++){
    c[i]=c[i]+c[i-1];
  }
// here value of c at smallest element will be 1 before that element c will be 0..
  // value of c at secondminimum value will 2... and so on..
  for(int i=n;i>=1;i--){
    b[c[a[i]]]=a[i];
    c[a[i]]--;
  }
