...
public class Main {
    public static void main(String[] args) {
        HashMap<String,Integer>mpp = new HashMap<>(); // value stored randomly // t.c = o(1) for all
        // TreeMap<String,Integer>mpp = new TreeMap<>();  // value sorted according to key in ascending order // t.c = o(n) for all 
        mpp.put("one", 1);
        mpp.put("two",2);
        mpp.put("three",3);
        mpp.put("four",4);
        ...
        mpp.remove("five");
        System.out.println(mpp);
        System.out.println(mpp.get("four"));
        mpp.clear();
    }    
}
